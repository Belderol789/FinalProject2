...
//  FinalProject
//
//  Created by Yohan on 24/05/2017.
...
public class UserInterfaceDesign : NSObject {
    ...
    private struct Cache {
        ...
        static var imageOfSliderMenu: UIImage?
        static var sliderMenuTargets: [AnyObject]?
    }
    ...
    public dynamic class func drawDiscussionCategory(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 533, height: 533), resizing: ResizingBehavior = .aspectFit, pressed: Bool = true) {
        ...
        //// Text 11 Drawing
        let text11Rect = CGRect(x: 18, y: 118, width: 499, height: 304)
        let text11TextContent = "WORK"
        let text11Style = NSMutableParagraphStyle()
        text11Style.alignment = .center
        let text11FontAttributes = [NSFontAttributeName: UIFont.systemFont(ofSize: 150), NSForegroundColorAttributeName: white, NSParagraphStyleAttributeName: text11Style]
    ...
    public dynamic class func drawVacationCategory(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 564, height: 564), resizing: ResizingBehavior = .aspectFit, pressed: Bool = true) {
        ...
        if (pressed) {
            ...
            let textTextContent = "TRAVEL"
            let textStyle = NSMutableParagraphStyle()
            textStyle.alignment = .center
            let textFontAttributes = [NSFontAttributeName: UIFont.systemFont(ofSize: 134), NSForegroundColorAttributeName: white, NSParagraphStyleAttributeName: textStyle]
    ...
    public dynamic class func drawArtCategory(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 768, height: 768), resizing: ResizingBehavior = .aspectFit, pressed: Bool = true) {
        ...
        if (pressed) {
            ...
            //// Text Drawing
            let textRect = CGRect(x: 50, y: 223, width: 669, height: 340)
            let textTextContent = "CHARITY"
            let textStyle = NSMutableParagraphStyle()
            textStyle.alignment = .center
            let textFontAttributes = [NSFontAttributeName: UIFont.systemFont(ofSize: 163), NSForegroundColorAttributeName: white, NSParagraphStyleAttributeName: textStyle]
    ...
    public dynamic class func drawTravelTableViewSymbol(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 564, height: 1055), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 564, height: 1055), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 564, y: resizedFrame.height / 1055)
        ...
        context.translateBy(x: 0, y: 0)
        context.scaleBy(x: 1, y: -1)
        context.translateBy(x: 0, y: -travelTableView2.size.height)
        context.draw(travelTableView2.cgImage!, in: CGRect(x: 0, y: 0, width: travelTableView2.size.width, height: travelTableView2.size.height))
        context.restoreGState()
    ...
    public dynamic class func drawCharity(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 564, height: 1002), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 564, height: 1002), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 564, y: resizedFrame.height / 1002)



        //// Image Declarations
        let charityTableView = UIImage(named: "charityTableView.jpg")!

        //// Picture Drawing
        let picturePath = UIBezierPath()
        picturePath.move(to: CGPoint(x: 0, y: 1002))
        picturePath.addLine(to: CGPoint(x: 564, y: 1002))
        picturePath.addLine(to: CGPoint(x: 564, y: 0))
        picturePath.addLine(to: CGPoint(x: 0, y: 0))
        picturePath.addLine(to: CGPoint(x: 0, y: 1002))
        picturePath.close()
        context.saveGState()
        picturePath.addClip()
        context.translateBy(x: 0, y: 0)
        context.scaleBy(x: 1, y: -1)
        context.translateBy(x: 0, y: -charityTableView.size.height)
        context.draw(charityTableView.cgImage!, in: CGRect(x: 0, y: 0, width: charityTableView.size.width, height: charityTableView.size.height))
        context.restoreGState()
    ...
    public dynamic class func drawWork(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 260, height: 460), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 260, height: 460), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 260, y: resizedFrame.height / 460)



        //// Image Declarations
        let discussionTableView = UIImage(named: "discussionTableView.jpg")!

        //// Picture Drawing
        let picturePath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 260, height: 460))
        context.saveGState()
        picturePath.addClip()
        context.translateBy(x: 0, y: 0)
        context.scaleBy(x: 1, y: -1)
        context.translateBy(x: 0, y: -discussionTableView.size.height)
        context.draw(discussionTableView.cgImage!, in: CGRect(x: 0, y: 0, width: discussionTableView.size.width, height: discussionTableView.size.height))
        context.restoreGState()
    ...
    public dynamic class func drawFoodCat(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 564, height: 1002), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Image Declarations
        let foodTableView = UIImage(named: "foodTableView.jpg")!

        //// Picture Drawing
        let picturePath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 564, height: 1001))
        context.saveGState()
        picturePath.addClip()
        context.translateBy(x: 0, y: 0)
        context.scaleBy(x: 1, y: -1)
        context.translateBy(x: 0, y: -foodTableView.size.height)
        context.draw(foodTableView.cgImage!, in: CGRect(x: 0, y: 0, width: foodTableView.size.width, height: foodTableView.size.height))
        context.restoreGState()
    ...
    public dynamic class func drawFun(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 564, height: 1002), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Image Declarations
        let funTableView = UIImage(named: "funTableView.jpg")!
        ...
        context.translateBy(x: 0, y: 0)
        context.scaleBy(x: 1, y: -1)
        context.translateBy(x: 0, y: -funTableView.size.height)
        context.draw(funTableView.cgImage!, in: CGRect(x: 0, y: 0, width: funTableView.size.width, height: funTableView.size.height))
        context.restoreGState()
    ...
    public dynamic class func drawSportCat(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 564, height: 1002), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Image Declarations
        let sportTableView = UIImage(named: "sportTableView.jpg")!
        ...
        context.translateBy(x: 0, y: 0)
        context.scaleBy(x: 1, y: -1)
        context.translateBy(x: 0, y: -sportTableView.size.height)
        context.draw(sportTableView.cgImage!, in: CGRect(x: 0, y: 0, width: sportTableView.size.width, height: sportTableView.size.height))
        context.restoreGState()
    ...
    public dynamic class func drawSliderMenuSymbol(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 400, height: 600), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 400, height: 600), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 400, y: resizedFrame.height / 600)



        //// Image Declarations
        let slideMenu2 = UIImage(named: "slideMenu2.jpg")!

        //// Picture Drawing
        let picturePath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 400, height: 600))
        context.saveGState()
        picturePath.addClip()
        context.translateBy(x: 0, y: 0)
        context.scaleBy(x: 1, y: -1)
        context.translateBy(x: 0, y: -slideMenu2.size.height)
        context.draw(slideMenu2.cgImage!, in: CGRect(x: 0, y: 0, width: slideMenu2.size.width, height: slideMenu2.size.height))
        context.restoreGState()
    ...
    public dynamic class func drawHostedTableViewSymbol(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 564, height: 1001), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 564, height: 1001), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 564, y: resizedFrame.height / 1001)



        //// Image Declarations
        let hosted = UIImage(named: "hosted.jpg")!
        ...
        context.translateBy(x: 0, y: 0)
        context.scaleBy(x: 1, y: -1)
        context.translateBy(x: 0, y: -hosted.size.height)
        context.draw(hosted.cgImage!, in: CGRect(x: 0, y: 0, width: hosted.size.width, height: hosted.size.height))
        context.restoreGState()
    ...
    public dynamic class func drawJoinedTableViewSymbol(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 236, height: 419), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 236, height: 419), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 236, y: resizedFrame.height / 419)



        //// Image Declarations
        let joined = UIImage(named: "joined.jpg")!

        //// Picture Drawing
        let picturePath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 236, height: 419))
        context.saveGState()
        picturePath.addClip()
        context.translateBy(x: 0, y: 0)
        context.scaleBy(x: 1, y: -1)
        context.translateBy(x: 0, y: -joined.size.height)
        context.draw(joined.cgImage!, in: CGRect(x: 0, y: 0, width: joined.size.width, height: joined.size.height))
        context.restoreGState()
    ...
    public dynamic class func drawSportTableView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 375, height: 511), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        UserInterfaceDesign.drawSportCat(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch)
        context.restoreGState()
    ...
    public dynamic class func drawFunTableView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 375, height: 511), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        UserInterfaceDesign.drawFun(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch)
        context.restoreGState()
    ...
    public dynamic class func drawWorkTableView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 375, height: 511), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        UserInterfaceDesign.drawWork(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch)
        context.restoreGState()
    ...
    public dynamic class func drawFoodTableView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 375, height: 511), resizing: ResizingBehavior = .aspectFit) {
        ...
        UserInterfaceDesign.drawFoodCat(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch)
        context.restoreGState()
    ...
    public dynamic class func drawCharityTableView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 375, height: 511), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Symbol Drawing
        let symbolRect = CGRect(x: 0, y: 0, width: 375, height: 812)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)

        UserInterfaceDesign.drawCharity(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch)
        context.restoreGState()
    ...
    public dynamic class func drawSliderMenu(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 202, height: 513), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Color Declarations
        let color5 = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.647)

        //// Symbol Drawing
        let symbolRect = CGRect(x: 0, y: -250, width: 400, height: 763)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)

        UserInterfaceDesign.drawSliderMenuSymbol(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch)
        context.restoreGState()


        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 202, height: 513))
        color5.setFill()
        rectanglePath.fill()
    ...
    public dynamic class func drawHostedTableView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 375, height: 511), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Symbol Drawing
        let symbolRect = CGRect(x: 0, y: 0, width: 375, height: 656)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)

        UserInterfaceDesign.drawHostedTableViewSymbol(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch)
        context.restoreGState()
    ...
    public dynamic class func drawJoinedTableView(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 375, height: 511), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Symbol Drawing
        let symbolRect = CGRect(x: 0, y: 0, width: 375, height: 709)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)

        UserInterfaceDesign.drawJoinedTableViewSymbol(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch)
        context.restoreGState()
    ...
    public dynamic class var imageOfSliderMenu: UIImage {
        if Cache.imageOfSliderMenu != nil {
            return Cache.imageOfSliderMenu!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 202, height: 513), false, 0)
            UserInterfaceDesign.drawSliderMenu()

        Cache.imageOfSliderMenu = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    @IBOutlet dynamic var sliderMenuTargets: [AnyObject]! {
        get { return Cache.sliderMenuTargets }
        set {
            Cache.sliderMenuTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: UserInterfaceDesign.imageOfSliderMenu)
            }
        }
    }
