...
//  FinalProject
//
//  Created by Yohan on 18/05/2017.
...
public class UserInterfaceDesign : NSObject {
    ...
    public dynamic class func drawCanvas3(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 768, height: 768), resizing: ResizingBehavior = .aspectFit, pressed: Bool = true) {
    ...
    public dynamic class func drawCanvas4(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 800, height: 800), resizing: ResizingBehavior = .aspectFit, pressed: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        if (pressed) {
            //// Group
            //// Picture Drawing
            let picturePath = UIBezierPath(rect: CGRect(x: -1, y: 0, width: 800, height: 800))
            context.saveGState()
            picturePath.addClip()
            ...
            //// Rectangle Drawing
            let rectanglePath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 800, height: 800))
            UserInterfaceDesign.foodCategoryOverlay.setFill()
            rectanglePath.fill()


            //// Text 2 Drawing
            let text2Rect = CGRect(x: 65, y: 239, width: 669, height: 322)
    ...
    public dynamic class func drawCanvas5(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 563, height: 563), resizing: ResizingBehavior = .aspectFit, pressed: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    public dynamic class func drawCanvas6(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 533, height: 533), resizing: ResizingBehavior = .aspectFit, pressed: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    public dynamic class func drawCanvas7(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 564, height: 564), resizing: ResizingBehavior = .aspectFit, pressed: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    public dynamic class func drawCanvas8(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 768, height: 768), resizing: ResizingBehavior = .aspectFit, pressed: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
