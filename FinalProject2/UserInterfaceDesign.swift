...
//  FinalProject
//
//  Created by Yohan on 21/05/2017.
...
public class UserInterfaceDesign : NSObject {
    ...
    public dynamic class func drawSliderMenu(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 202, height: 513), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 0.5, y: 156.5))
        bezierPath.addCurve(to: CGPoint(x: 202.5, y: 156.5), controlPoint1: CGPoint(x: 202.5, y: 155.5), controlPoint2: CGPoint(x: 202.5, y: 156.5))
